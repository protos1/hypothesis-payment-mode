<template>
  <section class="s1-U__width--900px" style="margin: 0 auto;">
    ...
    <div class="s1-U__pd--bt32 s1-U__pd--tp32">
      <h1 class="md-display-1">Profiles</h1>
    </div>
    ...
    <!-- LIST -->
    <article v-if="StoreData.Profile.length > 0">
      <header
      ...
      <div class="md-layout md-gutter">
        <div
          ...
          v-for="profile in StoreData.Profile"
          :key="profile.Id"
        >
          <md-card>
            ...
            <div class="s1-U__text-align--right s1-U__pd16 s1-U__pd--tp0">
              <md-button
                ...
                @click="remove('Profile', profile.Id, 'Name', 'profile')"
              >
                <md-icon>delete</md-icon>
              </md-button>
              <md-button
                class="md-icon-button"
                @click="edit('Profile', profile.Id, 'Profile-Name')"
              >
